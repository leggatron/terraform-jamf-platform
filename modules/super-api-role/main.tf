...
resource "jamfpro_api_role" "super_role" {
  display_name = "Super Admin Role"
...
resource "jamfpro_api_integration" "super_api_client" {
  display_name                  = "Super API Client"
  enabled                       = true
  access_token_lifetime_seconds = 6000
  authorization_scopes          = [jamfpro_api_role.super_role.display_name]
}
